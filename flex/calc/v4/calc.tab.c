...
{
  "$end", "error", "$undefined", "NUMBER", "EOL", "OP", "CP", "GT_OP",
  "LT_OP", "GTE_OP", "LTE_OP", "EQ_OP", "NE_OP", "'+'", "'-'", "'*'",
  "'/'", "'('", "')'", "$accept", "grammar", "expr_bool", "expr", "factor",
  "term", YY_NULLPTR
};
#endif
...
{
     -10,     0,   -10,   -10,    -1,    -2,    20,    12,    -8,   -10,
     -10,    -9,   -10,    -2,    -2,    -2,    -2,    -2,    -2,   -10,
      -2,    -2,    -2,    -2,   -10,    21,    21,    21,    21,    21,
      21,    -8,    -8,   -10,   -10
};
...
{
       2,     0,     1,    18,     0,     0,     0,     5,    12,    15,
      19,     0,     3,     0,     0,     0,     0,     0,     0,     4,
       0,     0,     0,     0,    20,     6,     8,     7,     9,    10,
      11,    13,    14,    16,    17
};
...
{
       2,     3,    10,     3,    20,    21,     0,    22,    23,    24,
      11,     0,     4,     0,     4,     5,    19,     5,    25,    26,
      27,    28,    29,    30,    12,    20,    21,    13,    14,    15,
      16,    17,    18,     0,    20,    21,    31,    32,     0,    33,
      34
};

static const yytype_int8 yycheck[] =
{
       0,     3,     3,     3,    13,    14,    -1,    15,    16,    18,
       5,    -1,    14,    -1,    14,    17,     4,    17,    13,    14,
      15,    16,    17,    18,     4,    13,    14,     7,     8,     9,
      10,    11,    12,    -1,    13,    14,    20,    21,    -1,    22,
      23
};
...
{
       0,    20,     0,     3,    14,    17,    21,    22,    23,    24,
       3,    22,     4,     7,     8,     9,    10,    11,    12,     4,
