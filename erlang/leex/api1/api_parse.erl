...
yeccpars2_2(_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccgoto_expr_list(hd(Ss), Cat, Ss, Stack, T, Ts, Tzr).
...
yeccpars2_6_(__Stack0) ->
 ...
 [begin
   { expr , { var , unwrap ( __1 ) } , memberof , __3 }
  end | __Stack].
...
-file("api_parse.yrl", 20).
yeccpars2_18_(__Stack0) ->
 [__3,__2,__1 | __Stack] = __Stack0,
 [begin
   { expr , { var , unwrap ( __1 ) } , unwrap ( __2 ) , __3 }
  end | __Stack].

-compile({inline,yeccpars2_21_/1}).
-file("api_parse.yrl", 15).
